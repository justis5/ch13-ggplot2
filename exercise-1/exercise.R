...
ggplot(data = diamonds_sample) + geom_point(mapping = aes(x = carat, y = price), alpha = 0.3) +
...
ggplot(data = diamonds, aes(x=factor(clarity), y = price)) + stat_summary(fun.y = "mean", geom = "bar")
